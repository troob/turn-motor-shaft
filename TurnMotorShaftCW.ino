...
void calcRotVel()
{
  ...
  Serial.print(" s, setRotPos = ");
  Serial.print(theta);
  Serial.print(" deg, latestRotPos = ");
  ...
  if(dt > 0)
  {
    ...
    {
      curRotVel = 1000.0 * ( latestRotPos - prevRotPos ) / dt; //* pubVelRate;
...
//    prevD = D;
//  
//    pwmPulse += (int) round( dP + dI + dD );
    
    errRotVel = setRotVel - pubRotVel; // [deg/s]
